...
namespace local_noactivitiesnotemptyactualcourses\analytics\target;

use local_noactivitiesnotemptyactualcourses\analytics\indicator\just_files_resources_and_a_forum;
...
class for_your_files_only extends \core_analytics\local\target\binary {
    ...
    public static function get_name() : \lang_string {
        return new \lang_string('target:foryourfilesonlyactivity', 'local_noactivitiesnotemptyactualcourses');
    }
    ...
    protected static function classes_description() {
        return array(
            get_string('targetlabelfilesonlyyes', 'local_noactivitiesnotemptyactualcourses'),
            get_string('targetlabelfilesonlyno', 'local_noactivitiesnotemptyactualcourses'),
        );
    }
    ...
    protected function calculate_sample($sampleid, \core_analytics\analysable $analysable, $starttime = false, $endtime = false) {
        ...
        $onlyfilesindicator = $this->retrieve('\local_noactivitiesnotemptyactualcourses\analytics\indicator\just_files_resources_and_a_forum', $sampleid);
