...
/**
 * Strings for component 'local_noactivitiesnotemptyactualcourses', language 'en'
 *
...
$string['pluginname'] = 'Analytics: no activities, but actual courses with enrolled teacher and students';
$string['target:foryourfilesonlyactivity'] = 'Only files and a forum';
$string['target:foryourfilesonlyactivity_help'] = 'This target describes whether courses running now have teaching activity, provided there are teachers and students.';
$string['targetlabelfilesonlyyes'] = 'There are files in the course';
